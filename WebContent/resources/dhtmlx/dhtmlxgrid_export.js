...
// sheetName parameter 추가
dhtmlXGridObject.prototype.toPDF=function(url,mode,header,footer,rows,target,sheetName){
	var save_sel = {
...
// sheetName parameter 추가
dhtmlXGridObject.prototype.toExcel = function(url,mode,header,footer,rows,sheetName) {
	if (!document.getElementById('dhx_export_iframe')) {
	...
	this.toPDF(url,mode,header,footer,rows,target,sheetName);
}
